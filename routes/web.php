...
// ===== LANDING SETELAH LOGIN (redirect per role) =====
Route::middleware([
    'auth:sanctum',
...
Route::middleware([
    ...
    // Verifikasi pembayaran (gerbang 1)
    ...
    // Verifikasi dokumen per item (gerbang 2)
    ...
    // Nomor urut tampil + kunci alokasi
    ...
    // ===== REKAP & JUARA (Modul 7) — URUTAN PENTING =====
...
// ============================================================
// AREA JURI  (penilaian WAJIB di sini, BUKAN di sekolah)
// ============================================================
Route::middleware([
    'auth:sanctum',
    config('jetstream.auth_session'),
