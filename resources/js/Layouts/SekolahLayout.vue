...
defineProps({
    header: { type: String, default: 'Operator Sekolah' },
});
        ...
        <div class="flex">
            ...
            <aside class="w-64 min-h-screen bg-forest text-parchment hidden md:block">
                <div class="p-6 border-b border-white/10">
                    <div class="font-display text-xl font-semibold tracking-wide">PERSIMANU</div>
                    <div class="text-xs text-parchment/70 mt-1">Panel Operator Sekolah</div>
                </div>
            ...
            <div class="flex-1 flex flex-col min-h-screen">
                <header class="bg-white border-b border-line">
                    <div class="px-6 py-4 flex items-center justify-between">
                        <h1 class="font-display text-2xl font-semibold text-forest">{{ header }}</h1>
