...
class Kontingen extends Model implements HasMedia
{
  ...
  protected $fillable = [
    ...
    'status',
    'nama_kontingen',
    'nama_kepala_madrasah',   // ✅ tambah
    'asal_instansi',          // ✅ tambah
    'contact_person',         // ✅ tambah
    'contact_phone',          // ✅ tambah
    'pendamping_putra',       // ✅ tambah
    'pendamping_putri',       // ✅ tambah
    'peserta_putra',          // ✅ tambah
    'peserta_putri',          // ✅ tambah
    'catatan_pembayaran',
    'approved_by',
    'approved_at',
    'finalized_at',
